...
soft3 is a closed cybernetic loop of **seven verbs, one per facet** — drawn at [soft3.org/scheme](https://soft3.org/scheme), parts at [soft3.org/chart](https://soft3.org/chart), states in [[status]].

**The boundary rule: a component is stack iff some closure of the loop cannot happen without it.** Everything else is *enrichment* (a richer way to perform a station) or a *product* (consumes the loop entire). To decide any component, ask which closure breaks without it.

## the seven steps

| # | verb | facet | what happens | core |
|---|---|---|---|---|
| 1 | **say** | word | a thought becomes a sentence | the signal itself |
| 2 | **sign** | space | a neuron seals it, the wire carries it | [[mudra]] · [[radio]] |
| 3 | **link** | mass | the graph grows | [[cell]] · [[soft3/cybergraph\|cybergraph]] |
...
**form is the measure** — hash is the ruler, commitment the gauge, the field ([[strata]]) the unit system. The green arc closes the loop: the measurement becomes the next word. Measurement is in the loop from degree one — the germ wire already hashes every particle with hemera.
...
**core** (the loop breaks without it):
...
| component | enriches | how |
|---|---|---|
| [[neural]] | say | meaning as graph structure |
| [[trident]] | say | compile to provable bytecode |
| [[rune]] | say | scripted, effectful saying |
| [[inf]] | say | asking as saying — datalog with proofs |
| [[tape]] | sign | typed framing on the wire |
| [[vault]] | sign | keep the secrets that sign — proposed |
| [[fs]] | link | particles mounted as files |
| [[tok]] | link | value moves as links |
| [[wysm]] | prove | any wasm, metered |
| [[glia]] | prove | model inference, conditional |
