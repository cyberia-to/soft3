...
---
# crystallization — the boundary and the core

soft3 has seven seats, and they form no chain. the perfected structure is **7 = 3 + 3 + 1**: three motions, three guarantees, one attractor — drawn at [soft3.org/scheme](https://soft3.org/scheme), parts at [soft3.org/chart](https://soft3.org/chart), states in [[status]].
...
sign, link and prove are what the chain drafts mistook for steps. they are properties of the channel every motion passes through:

| guarantee | facet | what it promises | core |
|---|---|---|---|
| **signed** | space | every word is owned | [[mudra]] — enriched by [[vault]] [[tape]] |
...
|---|---|---|---|
| 1 · medium | signed + linked | **shared** | **live** — [[wire]], 2026-09-01 |
| 2 · proof | + proven | **trustless** | building — zheng openings open |
| 3 · mind | + focus | **one** | undeployed — foculus has never chosen a fork |

**shared → trustless → one.** the centre lights last: the mind emerges when a proven, shared loop converges. this dissolves the old partition's degeneracy — stages no longer carve stations off a chain (4, then +2, then +1); each stage is one whole layer of the drawing. the trinity maps onto the layers: [[cyb]] is the body that runs the loop, [[cyber]] is the mind that lights at stage 3, [[cyberia]] is the state that governs what the alive loop does.

## the stage tests

a stage is claimed only when a signal demonstrably completes the circuit on that layer:
...
**core** (the boundary rule holds):

| component | seat | layer |
|---|---|---|
| [[cell]] | linked | medium |
| [[soft3/cybergraph\|cybergraph]] | linked | medium |
| [[radio]] | linked | medium |
| [[mudra]] | signed | medium |
| [[soft3/nox\|nox]] | proven | proof |
| [[zheng]] | proven | proof |
| [[soft3/bbg\|bbg]] | proven | proof |
| [[strata]] | proven | proof |
| [[tru]] | focus | centre |
| [[foculus]] | focus | centre |
| [[hemera]] | observe | loop |
...
**Focus:** the medium is four components — [[cell]], [[soft3/cybergraph|cybergraph]], [[radio]], [[mudra]] — hardening those beats widening anything. **Honesty:** [[status]] states map onto layer states. **Discipline:** a proposed component must name its seat — motion, guarantee, or centre; "it would be nice" is not a seat.
